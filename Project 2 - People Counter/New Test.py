...
import math
from sort import *
# Enable CUDA (NVIDIA GPU support) in OpenCV
cv2.cuda.setDevice(1)  # Choose your GPU device index
...
# FPS Calculation
fps_counter = cv2.cuda.createCudaTimer()
fps_counter.start()
...
while True:
    ...
    fps_counter.stop()
    fps = 1000.0 / fps_counter.getTimeMilli()
    fps_counter.start()
