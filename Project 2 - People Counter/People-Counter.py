...
#
#     cv2.imshow("ImageRegion", cv2.resize(imgRegion, (0, 0), fx=0.5, fy=0.5))
#     cv2.waitKey(1)
...
#
# #cap = cv2.VideoCapture("../Videos/drill.mp4")  # For Video
# cap = cv2.VideoCapture(0)  # Use the laptop webcam
# cap.set(3, 640)  # Set width to 640
# cap.set(4, 640)  # Set height to 640
...
#
# limitsUp = [(700, 520), (800, 520), (850, 1080), (750, 1080)]
# # limitsDown = [0, 0, 0, 0]
